...
namespace FirstWebAPI.Controllers
{
        ...
        private User[] users = new User[]
   {
        ...
        new User { id = 6, name = "AB De Villiers", email = "email5@mail.com", phone = "01111111", role = 3},
        new User { id = 7, name = "Chris Gayle", email = "email5@mail.com", phone = "01111111", role = 3}
   };
        // GET: api/Users
